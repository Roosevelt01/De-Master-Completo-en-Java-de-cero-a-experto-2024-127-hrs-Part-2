...
insert into direcciones(calle, numero) values('vaticanos', 123);
...
insert into facturar (descripcion, total, id_cliente) values('oficina', 4000, 1);
insert into facturar (descripcion, total, id_cliente) values('casa', 2000, 1);
insert into facturar (descripcion, total, id_cliente) values('deporte', 3000, 1);
insert into facturar (descripcion, total, id_cliente) values('computacion', 7000, 2);
